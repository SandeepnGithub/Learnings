...
public class NthMostFrequentNumber 
{
    private class NumberFrequencyTuple
    {
		...
		public String toString() {
			return "NumberFrequencyTuple [number=" + number + ", frequency="
					+ frequency + "]";
		}
    ...
    public int findNthMostFrequentNumber(int[] array, int n)
    {
        ...
        for(NumberFrequencyTuple numberFrequencyTuple:list){
        	System.out.println(numberFrequencyTuple);
        }
